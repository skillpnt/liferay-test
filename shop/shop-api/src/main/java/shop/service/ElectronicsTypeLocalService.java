...
public interface ElectronicsTypeLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>shop.service.impl.ElectronicsTypeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the electronics type local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ElectronicsTypeLocalServiceUtil} if injection and service tracking are not available.
	 */
