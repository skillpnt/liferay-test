 ...
 * <code>shop.service.impl.ElectronicsTypeLocalServiceImpl</code> and
...
public class ElectronicsTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>shop.service.impl.ElectronicsTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ElectronicsType createElectronicsType(
		long electronicsTypeId) {

		return getService().createElectronicsType(electronicsTypeId);
	}
	 ...
	 */
	public static ElectronicsType deleteElectronicsType(long electronicsTypeId)
		throws PortalException {

		return getService().deleteElectronicsType(electronicsTypeId);
	}
	...
	public static ElectronicsType fetchElectronicsType(long electronicsTypeId) {
		return getService().fetchElectronicsType(electronicsTypeId);
	}
	 ...
	 * @throws PortalException if a electronics type with the primary key could not be found
	 */
	public static ElectronicsType getElectronicsType(long electronicsTypeId)
		throws PortalException {

		return getService().getElectronicsType(electronicsTypeId);
	}
