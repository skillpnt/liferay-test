...
/**
 * The persistence utility for the electronics employee service. This utility wraps <code>shop.service.persistence.impl.ElectronicsEmployeePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ElectronicsEmployeePersistence
 * @generated
 */
public class ElectronicsEmployeeUtil {
	 ...
	 */
	public static void clearCache(ElectronicsEmployee electronicsEmployee) {
		getPersistence().clearCache(electronicsEmployee);
	}
	 ...
	 */
	public static Map<Serializable, ElectronicsEmployee> fetchByPrimaryKeys(
	 ...
	 */
	public static List<ElectronicsEmployee> findWithDynamicQuery(
	 ...
	 */
	public static ElectronicsEmployee update(
		ElectronicsEmployee electronicsEmployee) {

		return getPersistence().update(electronicsEmployee);
	}
	...
	public static ElectronicsEmployee update(
		...
		return getPersistence().update(electronicsEmployee, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(ElectronicsEmployee electronicsEmployee) {
		getPersistence().cacheResult(electronicsEmployee);
	}
	...
	public static void cacheResult(
		List<ElectronicsEmployee> electronicsEmployees) {

		getPersistence().cacheResult(electronicsEmployees);
	}
	 ...
	 */
	public static ElectronicsEmployee create(
		shop.service.persistence.ElectronicsEmployeePK electronicsEmployeePK) {

		return getPersistence().create(electronicsEmployeePK);
	}
	 ...
	 */
	public static ElectronicsEmployee remove(
			shop.service.persistence.ElectronicsEmployeePK
				electronicsEmployeePK)
		throws shop.exception.NoSuchElectronicsEmployeeException {

		return getPersistence().remove(electronicsEmployeePK);
	}

	public static ElectronicsEmployee updateImpl(
		ElectronicsEmployee electronicsEmployee) {

		return getPersistence().updateImpl(electronicsEmployee);
	}
	 ...
	 * @throws NoSuchElectronicsEmployeeException if a electronics employee with the primary key could not be found
	 */
	public static ElectronicsEmployee findByPrimaryKey(
			shop.service.persistence.ElectronicsEmployeePK
				electronicsEmployeePK)
		throws shop.exception.NoSuchElectronicsEmployeeException {

		return getPersistence().findByPrimaryKey(electronicsEmployeePK);
	}
	 ...
	 */
	public static ElectronicsEmployee fetchByPrimaryKey(
		shop.service.persistence.ElectronicsEmployeePK electronicsEmployeePK) {

		return getPersistence().fetchByPrimaryKey(electronicsEmployeePK);
	}
	 ...
	 */
	public static List<ElectronicsEmployee> findAll() {
	 ...
	 */
	public static List<ElectronicsEmployee> findAll(int start, int end) {
	...
	public static ElectronicsEmployeePersistence getPersistence() {
		return _persistence;
	}

	private static volatile ElectronicsEmployeePersistence _persistence;
